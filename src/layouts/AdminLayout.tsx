...
const AdminLayout: React.FC = () => {
    ...
    // Helper function --SIDENAV ACTIVE LINK BG COLOUR
    ...
    return (
        <div className="g-sidenav-show bg-gray-100">
            ...
            <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2 bg-white my-2" id="sidenav-main">
                ...
                <div className="cursor-default collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <Link to="/admindashboard" className={getNavLinkClass('/admindashboard')}>
                                <i className="material-symbols-rounded opacity-5">dashboard</i>
                                <span className="nav-link-text ms-1">Dashboard</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            {/* For placeholder links, you can pass their exact href or just leave them with the helper looking for a fake path */}
                            <a href="#!" className={getNavLinkClass('/tables')}>
                        ...
                        <li className="nav-item">
                            <Link to="/userenrollment" className={getNavLinkClass('/userenrollment')}>
                                <i className="material-symbols-rounded opacity-5">person</i>
                                <span className="nav-link-text ms-1">User Enrollment</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/adduser" className={getNavLinkClass('/adduser')}>
                                <i className="material-symbols-rounded opacity-5">login</i>
                                <span className="nav-link-text ms-1">Add User</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/company-users')}>
                                <i className="material-symbols-rounded opacity-5">dataset</i>
                                <span className="nav-link-text ms-1">Company wise users</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/student-profile')}>
                                <i className="material-symbols-rounded opacity-5">assignment</i>
                                <span className="nav-link-text ms-1">Student Profile</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/search')}>
                                <i className="material-symbols-rounded opacity-5">search</i>
                                <span className="nav-link-text ms-1">Search</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/data-check')}>
                                <i className="material-symbols-rounded opacity-5">check_circle</i>
                                <span className="nav-link-text ms-1">Data check</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/course-data-check')}>
                                <i className="material-symbols-rounded opacity-5">check_box</i>
                                <span className="nav-link-text ms-1">Course Data Check</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/get-profile')}>
                                <i className="material-symbols-rounded opacity-5">account_box</i>
                                <span className="nav-link-text ms-1">Get Profile</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="#!" className={getNavLinkClass('/emergency-profile')}>
                                <i className="material-symbols-rounded opacity-5">person_alert</i>
                                <span className="nav-link-text ms-1">Emergency Get Profile</span>
                            </a>
                        </li>
                    </ul>
                </div>
