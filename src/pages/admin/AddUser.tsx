                ...
                <div className="card mt-4">
                    ...
                    <div className="card-body p-3">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="cursor-default card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                    <p className="w-50 me-3 mb-0">Choose Course</p>
                    ...
                    <div className="card-body p-3">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div className="cursor-default card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                    <p className="w-50 me-3 mb-0">Mobile</p>
                                    <input className="form-input px-2 py-1 mb-0 w-100 border-0" placeholder="Enter 10 digit number..." name="myInput" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-6 mb-md-0 mb-4">
                                <div className="d-flex justify-content-start align-items-center">
                                    ...
                                    >
                                        <i className="material-symbols-rounded text-sm">save</i>
